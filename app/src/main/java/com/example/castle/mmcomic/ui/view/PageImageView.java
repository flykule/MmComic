...
public class PageImageView extends ImageView {
    private Constant.PageViewMode mViewMode;
    ...
    public void setViewMode(Constant.PageViewMode viewMode) {
        mViewMode = viewMode;
        mSkipScaling = false;
        requestLayout();
        invalidate();
    ...
    private void init() {
        ...
        mViewMode = Constant.PageViewMode.ASPECT_FIT;
    }
    ...
    private void scale() {
        ...
        if (mViewMode == Constant.PageViewMode.ASPECT_FILL) {
            float scale;
            float dx = 0;
        ...
        } else if (mViewMode == Constant.PageViewMode.ASPECT_FIT) {
        ...
        } else if (mViewMode == Constant.PageViewMode.FIT_WIDTH) {
